...
def generar(nombre):
    ...
    print("Claves para " + nombre + " generadas aqui (archivos.pem)")
...
def encriptar(nombre, texto):
    ...
    return privada.encrypt(texto, padding.OAEP(mgf=padding.MGF1(algorithm=hashes.SHA256()), algorithm=hashes.SHA256(), label=None))
